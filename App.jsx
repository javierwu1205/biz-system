...
// In-memory cache so we don't re-fetch on every login attempt
...
// Sync fallback for components that can't use async easily
...
function LoginScreen({ onLogin }) {
  ...
  function login() {
    ...
    getAccountsAsync().then(accts => {
      ...
      setErr("网络错误，请重试"); setLoading(false);
    });
  }
